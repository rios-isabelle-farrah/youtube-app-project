...
<NavLink className="allNavs" id="home" to={"/"}><img id="burger" height="80" width="80px" src="https://www.freepnglogos.com/uploads/youtube-play-red-logo-png-transparent-background-6.png"/><span id="youtube" className="widen">Youtube</span> </NavLink> */}
 <NavLink className="allNavs" id="home" to={"/"}><img id="burger" height="80" width="80px" src="https://icon-library.com/images/hamburger-menu-icon-transparent/hamburger-menu-icon-transparent-0.jpg"/><span id="youtube" className="widen"></span> </NavLink>
